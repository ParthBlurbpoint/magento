 ...
 */
class Kodematix_Storelocator_Helper_Image extends Mage_Core_Helper_Abstract
{
    /**
     ...
     * @var string
     */
    const MEDIA_PATH    = 'kodematix_storelocator';
    ...
    public function uploadImage($scope)
    {
        ...
        if ($adapter->isUploaded($scope)) {
            ...
            if (!$adapter->isValid($scope)) {
                Mage::throwException(Mage::helper('storelocator')->__('Uploaded image is not valid'));
            }
     ...
     * @return bool|string
     */
    public function resize(Kodematix_Storelocator_Model_Storelocator $store, $width, $height = null)
    {
