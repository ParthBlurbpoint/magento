...
abstract class Kodematix_Hidecatalog_Model_System_Config_Backend_Customergroup_Abstract extends Mage_Core_Model_Config_Data
{
    /**
    ...
    protected function _beforeSave()
    {
        ...
        if (is_array($value) && 1 < count($value)) {
            ...
            if (in_array(Kodematix_Hidecatalog_Helper_Data::USE_NONE, $value)) {
                $value = array(Kodematix_Hidecatalog_Helper_Data::USE_NONE);
                $this->setValue($value);
            }
        }
