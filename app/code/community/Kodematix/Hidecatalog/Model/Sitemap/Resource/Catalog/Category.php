...
class Kodematix_Hidecatalog_Model_Sitemap_Resource_Catalog_Category
    extends Mage_Sitemap_Model_Resource_Catalog_Category
{
    /**
     * @var Kodematix_Hidecatalog_Model_Sitemap_Resource_Catalog_Behavior_FilterSitemapAbstract
     */
     ...
     * DI setter
     *
     * @param Kodematix_Hidecatalog_Model_Sitemap_Resource_Catalog_Behavior_FilterSitemapAbstract $filter
     */
    public function setAddFilterBehavior(
        Kodematix_Hidecatalog_Model_Sitemap_Resource_Catalog_Behavior_FilterSitemapAbstract $filter)
    {
     ...
     * DI getter
     *
     * @return Kodematix_Hidecatalog_Model_Sitemap_Resource_Catalog_Behavior_FilterSitemapAbstract
     */
    private function _getNotLoggedInBehavior()
    {
        if (! $this->_notLoggedInBehavior) {
            $this->_notLoggedInBehavior = Mage::getModel('kodematix_hidecatalog/sitemap_resource_catalog_behavior_filterSitemapCategory');
        }
