...
class Kodematix_Hidecatalog_Model_Sitemap_Resource_Catalog_Product
    extends Mage_Sitemap_Model_Resource_Catalog_Product
{
    ...
    private function _getNotLoggedInBehavior()
    {
        if (! $this->_notLoggedInBehavior) {
            $this->_notLoggedInBehavior = Mage::getModel('kodematix_hidecatalog/sitemap_resource_catalog_behavior_filterSitemapProduct');
        }
