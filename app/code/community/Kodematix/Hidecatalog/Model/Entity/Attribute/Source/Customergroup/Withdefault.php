...
class Kodematix_Hidecatalog_Model_Entity_Attribute_Source_Customergroup_Withdefault
...
{   
    ...
    public function getAllOptions()
    {
        if (is_null($this->_options)) {
            $this->_options = array(
                array(
                    'value' => Kodematix_Hidecatalog_Helper_Data::USE_DEFAULT,
                    'label' => Mage::helper('kodematix_hidecatalog')->__(
                        Kodematix_Hidecatalog_Helper_Data::LABEL_DEFAULT
                    )
                ),
                array(
                    'value' => Kodematix_Hidecatalog_Helper_Data::USE_NONE,
                    'label' => Mage::helper('kodematix_hidecatalog')->__(
                        Kodematix_Hidecatalog_Helper_Data::LABEL_NONE
                    )
                )
            );
