...
class Kodematix_Hidecatalog_Model_Indexer_Category extends Kodematix_Hidecatalog_Model_Indexer_Abstract
{
    /**
    ...
    {
        $this->_init('kodematix_hidecatalog/indexer_category');
    }
    ...
    {
        return Mage::helper('kodematix_hidecatalog')->__('GroupsCatalog Categories');
    }
    ...
    {
        return Mage::helper('kodematix_hidecatalog')->__('Reindex Customergroup Category Visibility');
    }
