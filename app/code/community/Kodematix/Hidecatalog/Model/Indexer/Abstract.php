...
abstract class Kodematix_Hidecatalog_Model_Indexer_Abstract extends Mage_Index_Model_Indexer_Abstract
{
    /**
    ...
    protected function _registerEvent(Mage_Index_Model_Event $event)
    {
        ...
        $attrCode = Kodematix_Hidecatalog_Helper_Data::HIDE_GROUPS_ATTRIBUTE;
