 ...
 */
class Kodematix_Hidecatalog_Model_Resource_Filter
    extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    /**
     * Inner join the hidecatalog index table to hide entities not visible to the specified customer group id
     *
     * @param Varien_Data_Collection_Db $collection
    ...
    /**
     * Inner join the hidecatalog index table to hide wishlist items whose
    ...
    /**
     * Checks the given entities visibility against the hidecatalog index
     *
    ...
    /**
     * Checks the list of ids against the hidecatalog index table and returns those that are visible
     *
    ...
    /**
     * Inner join the hidecatalog index table to not count products
    ...
    /**
     * Add the hidecatalog filter to a select instance returned by a product collection. More specifically
    ...
    /**
     * Add the hidecatalog filter to a product collection select instance.
     *
     * @param Zend_Db_Select $select
     * @param int $groupId
     * @param int $storeId
    ...
    /**
     * Add the hidecatalog filter to a category collection select instance.
     *
     * @param Zend_Db_Select $select
     * @param int $groupId
     * @param int $storeId
    ...
    /**
     * Add the hidecatalog filter to a product or category collection select instance.
     *
    ...
    /**
     * Join the specified hidecatalog index table to the passed select instance
     *
     * @param Zend_Db_Select $select
     * @param string $table The hidecatalog index table
     * @param int $groupId
     * @param int $storeId
