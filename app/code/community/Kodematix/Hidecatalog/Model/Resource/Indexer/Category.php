...
class Kodematix_Hidecatalog_Model_Resource_Indexer_Category
    extends Kodematix_Hidecatalog_Model_Resource_Indexer_Abstract
{
    ...
    {
        $this->_init('kodematix_hidecatalog/category_index', 'id');
    }
     ...
     * @return Kodematix_Hidecatalog_Model_Resource_Indexer_Category
