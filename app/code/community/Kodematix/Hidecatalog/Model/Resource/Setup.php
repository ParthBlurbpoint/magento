...
class Kodematix_Hidecatalog_Model_Resource_Setup extends Mage_Catalog_Model_Resource_Setup
{
    /**
    ...
    public function dropIndexTable($entityType)
    {
         ...
         */
        $tableAlias = Mage::helper('kodematix_hidecatalog')
    ...
    public function createIndexTable($entityType)
    {
        ...
        $table = $this->getConnection()->newTable($tableName)
            ...
            ->setComment('Hidecatalog ' . $entityType . ' Customer Group Index Table');
        $this->getConnection()->createTable($table);
    }

    public function addGroupsCatalogAttribute($entityType)
    {
        $attributeCode = Kodematix_Hidecatalog_Helper_Data::HIDE_GROUPS_ATTRIBUTE;
