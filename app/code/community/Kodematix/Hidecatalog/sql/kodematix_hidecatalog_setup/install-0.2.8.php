...
$installer->deleteTableRow(
    'eav/attribute', 'attribute_code', Kodematix_Hidecatalog_Helper_Data::HIDE_GROUPS_ATTRIBUTE
);

// Add new attributes
$installer->addAttribute('catalog_product', Kodematix_Hidecatalog_Helper_Data::HIDE_GROUPS_ATTRIBUTE, array(
    'label' => 'Hide/Show from Customer Groups',
    'group' => 'General',
    'type' => 'text',
    'input' => 'multiselect',
    'source' => 'kodematix_hidecatalog/entity_attribute_source_customergroup_withdefault',
    'backend' => 'kodematix_hidecatalog/entity_attribute_backend_customergroups',
    'frontend' => 'kodematix_hidecatalog/entity_attribute_frontend_customergroups',
    'input_renderer' => 'kodematix_hidecatalog/adminhtml_data_form_customergroup',
    'global' => Mage_Catalog_Model_Resource_Eav_Attribute::SCOPE_STORE,
    'required' => 0,
    'default' => Kodematix_Hidecatalog_Helper_Data::USE_DEFAULT,
    'user_defined' => 0,
...
$installer->addAttribute('catalog_category', Kodematix_Hidecatalog_Helper_Data::HIDE_GROUPS_ATTRIBUTE, array(
    'label' => 'Hide/Show from Customer Groups',
 ...
 */
$tableName = $installer->getTable('kodematix_hidecatalog/product_index');
...
$table = $installer->getConnection()->newTable($tableName)
    ...
    ->setComment('Hidecatalog Product Customer Group Index Table');
 ...
 */
$tableName = $installer->getTable('kodematix_hidecatalog/category_index');
...
$table = $installer->getConnection()->newTable($tableName)
    ...
    ->setComment('Hidecatalog Category Customer Group Index Table');
$installer->getConnection()->createTable($table);
