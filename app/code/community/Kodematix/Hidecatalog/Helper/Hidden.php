...
class Kodematix_Hidecatalog_Helper_Hidden extends Mage_Core_Helper_Abstract
{
    /**
     ...
     * @return Kodematix_Hidecatalog_Helper_Hidden
     */
    ...
    protected function _applyHiddenEntityRedirect($entityTypeCode)
    {
        ...
        switch ($type) {
            case Kodematix_Hidecatalog_Model_System_Config_Source_HiddenEntityHandling::HIDDEN_ENTITY_HANDLING_REDIRECT:
                return $this->_applyEntityRedirectTargetRoute($targetRouteSetting);
                break;

            case Kodematix_Hidecatalog_Model_System_Config_Source_HiddenEntityHandling::HIDDEN_ENTITY_HANDLING_REDIRECT_PARENT:
     ...
     * @return Kodematix_Hidecatalog_Model_Observer
     */
