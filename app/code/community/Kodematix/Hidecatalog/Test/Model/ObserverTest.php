...
/**
 * @see Kodematix_Hidecatalog_Model_Observer
 *
 * @loadSharedFixture global.yaml
 * @doNotIndexAll
 */
class Kodematix_Hidecatalog_Test_Model_ObserverTest extends EcomDev_PHPUnit_Test_Case
{
    /**
    ...
    public static function setUpBeforeClass()
    {
        ...
        // Rebuild Hidecatalog product index
        Mage::getModel('index/indexer')->getProcessByCode('hidecatalog_product')->reindexEverything();
    }
     ...
     * and applying test the hidecatalog filters are applied correctly.
     *
     * @test
