...
class Kodematix_Hidecatalog_Test_Model_Sitemap_Resource_Behavior_CategoryTest
    extends EcomDev_PHPUnit_Test_Case
{
    protected $class = 'Kodematix_Hidecatalog_Model_Sitemap_Resource_Catalog_Behavior_FilterSitemapCategory';

    /**
     * @return Kodematix_Hidecatalog_Model_Sitemap_Resource_Catalog_Behavior_FilterSitemapCategory
     */
    private function getInstance()
    {
        /** @var Kodematix_Hidecatalog_Model_Sitemap_Resource_Catalog_Behavior_FilterSitemapCategory $instance */
    ...
    {
        $stubHelper = $this->getMock('Kodematix_Hidecatalog_Helper_Data');
    ...
    {
        $mockFilter = $this->getMockBuilder('Kodematix_Hidecatalog_Model_Resource_Filter')
