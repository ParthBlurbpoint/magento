...
class Kodematix_Hidecatalog_Test_Model_Sitemap_Resource_ProductTest
    extends EcomDev_PHPUnit_Test_Case
{
    protected $class = 'Kodematix_Hidecatalog_Model_Sitemap_Resource_Catalog_Product';

    /**
     * @return Kodematix_Hidecatalog_Model_Sitemap_Resource_Catalog_Product
     */
    private function getInstance()
    {
        /** @var Kodematix_Hidecatalog_Model_Sitemap_Resource_Catalog_Product $instance */
    ...
    {
        $mockBehavior = $this->getMockBuilder('Kodematix_Hidecatalog_Model_Sitemap_Resource_Catalog_Behavior_FilterSitemapProduct')
            ->getMock();
