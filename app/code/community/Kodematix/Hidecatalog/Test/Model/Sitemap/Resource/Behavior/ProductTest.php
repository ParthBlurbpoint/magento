...
class Kodematix_Hidecatalog_Test_Model_Sitemap_Resource_Behavior_ProductTest
    extends EcomDev_PHPUnit_Test_Case
{
    protected $class = 'Kodematix_Hidecatalog_Model_Sitemap_Resource_Catalog_Behavior_FilterSitemapProduct';

    /**
     * @return Kodematix_Hidecatalog_Model_Sitemap_Resource_Catalog_Behavior_FilterSitemapProduct
     */
    private function getInstance()
    {
        /** @var Kodematix_Hidecatalog_Model_Sitemap_Resource_Catalog_Behavior_FilterSitemapProduct $instance */
