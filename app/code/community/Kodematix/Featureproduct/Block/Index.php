...
public function getStoreconfig() {
        ...
        $horizontal_carousels_setting_slide_itemsonpage = Mage::getStoreConfig('featureproduct/content_setting/slide_itemsonpage');
		...
		$minSlides = Mage::getStoreConfig('featureproduct/rightblock_setting/minSlides');
		$maxSlides = Mage::getStoreConfig('featureproduct/homepage_setting/maxSlides');
