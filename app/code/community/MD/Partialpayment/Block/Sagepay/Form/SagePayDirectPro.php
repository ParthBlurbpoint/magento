<?php
class MD_Partialpayment_Block_Sagepay_Form_SagePayDirectPro extends Mage_Core_Block_Template
{
    protected function _prepareLayout() {
        $this->setChild('token.cards.li',$this->getLayout()->createBlock('md_partialpayment/sagepay_form_tokenList', 'token.cards.li')->setCanUseToken($this->canUseToken())->setPaymentMethodCode('sagepaydirectpro'));
    ...
    protected function _construct()
    {
		...
		$this->setTemplate('md/partialpayment/summary/payment/form/sagePayDirectProWithToken.phtml');
    }

	public function allowGiftAid()
	{
		return (bool)((int)Mage::getStoreConfig('sagepaysuite/sagepaydirectpro/allow_gift_aid') === 1);
	}
    ...
    */
    ...
    {
        $availableTypes = explode(',', Mage::getStoreConfig('sagepaysuite/sagepaydirectpro/cctypesSagePayDirectPro'));
