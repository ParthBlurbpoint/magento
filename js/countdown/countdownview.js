    ...
    var clock = {
    	set: {
    		...
    		days: function () {
    			...
    			ctx.arc(35, 35, 32, deg(0), deg(360));
    			ctx.lineWidth = 6;
    			ctx.stroke();
    		...
    		hours: function () {
    			...
    			ctx.arc(35, 35, 32, deg(0), deg(15 * glob.hours), true);
    			ctx.lineWidth = 6;
    			ctx.stroke();
    		...
    		minutes: function () {
    			...
    			ctx.arc(35, 35, 32, deg(0), deg(6 * glob.minutes), true);
    			ctx.lineWidth = 6;
    			ctx.stroke();
    		...
    		seconds: function () {
    			...
    			ctx.arc(35, 35, 32, deg(0), deg(6 * glob.seconds), true);
    			ctx.lineWidth = 6;
    			ctx.stroke();
