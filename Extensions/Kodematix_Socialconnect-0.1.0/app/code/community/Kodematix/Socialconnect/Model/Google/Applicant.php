...
class Kodematix_Socialconnect_Model_Google_Applicant
{
    const REDIRECT_URI_ROUTE = 'socialconnect/google/connect';

    const XML_PATH_ENABLED = 'customer/kodematix_socialconnect_google/enabled';
    const XML_PATH_CLIENT_ID = 'customer/kodematix_socialconnect_google/client_id';
    const XML_PATH_CLIENT_SECRET = 'customer/kodematix_socialconnect_google/client_secret';
    ...
    protected function _httpRequest($url, $method = 'GET', $params = array())
    {
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401)) {
                ...
                throw new Kodematix_Socialconnect_GoogleOAuthException($message);
            } else {
                $message = sprintf(
                    Mage::helper('kodematix_socialconnect')
...
class Kodematix_Socialconnect_GoogleOAuthException extends Exception
{}
